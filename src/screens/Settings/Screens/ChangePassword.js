...
const ChangePassword = ({setChangePassword, handleSubmitPassword}) => {
    return (
        <div className='container-change-password-right'>
            ...
            <TextInput className="settings-right-inputs" onChange={(e)=>setChangePassword('email',e.target.value)} />
            ...
            <div className='settings-password-container'>
                <div className='settings-small-label-container'>
                    ...
                    <TextInput className="settings-right-inputs" onChange={(e)=>setChangePassword('password',e.target.value)} hideText/>
                </div>
                ...
                <div className='settings-small-label-container'>
                    ...
                    <TextInput className="settings-right-inputs" onChange={(e)=>setChangePassword('confirm',e.target.value)} hideText/>
                </div>
            </div>
